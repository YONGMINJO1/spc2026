...
docs = [
    Document(page_content="NVMe 는 SSD의 인터페이스 규격으로 PCIe를 사용한다"),
    Document(page_content="SATA SSD는 NVMe 보다 속도가 느리다"),
    Document(page_content="HDD는 회전 디스크 기반이라 IO가 느린편이다."),
    Document(page_content="파이썬은 인기 있는 프로그래밍 언어다."),
    Document(page_content="자바스크립트는 브라우저에서 작동하는 언어다."),
    Document(page_content="React는 메모리 안정성과 성능을 동시에 추구한다."),
]
