...
def code_check():
    ...
    prompt = (
        f"다음 소스코드를 보고 {', '.join(vulnerabilities)} 취약점을 분석하시오.\n"
        "각 취약점에 대해 해당 코드의 라인 번호, 코드 스니펫, 취약점 설명과 개선 방한을 간단하게 설명하시오. 코드 내의 주석은 무시해도 됩니다.\n\n"
        "소스코드: \n"
        "----------\n"
        f"{code}\n"
        "----------\n"
    ...
    response = client.chat.completions.create(
        model="gpt-4o-mini",
        messages=[
            {"role":"system", "content":"당신은 보안 소스코드 분석 보안 전문가 입니다."},
